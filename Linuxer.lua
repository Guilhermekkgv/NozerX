...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Dropdown(config)
            ...
            local DropdownPadding = Linux.Instance("UIPadding", {
                Parent = Dropdown,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.Input(config)
            ...
            local InputPadding = Linux.Instance("UIPadding", {
                Parent = Input,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.Label(config)
            ...
            local LabelPadding = Linux.Instance("UIPadding", {
                Parent = LabelFrame,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.Section(config)
            ...
            local SectionPadding = Linux.Instance("UIPadding", {
                Parent = Section,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.Keybind(config)
            ...
            local KeybindPadding = Linux.Instance("UIPadding", {
                Parent = Keybind,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.ColorPicker(config)
            ...
            local ColorPickerPadding = Linux.Instance("UIPadding", {
                Parent = ColorPicker,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.Paragraph(config)
            ...
            local ParagraphText = Linux.Instance("TextLabel", {
                Parent = ParagraphFrame,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -10, 0, 0),
                Position = UDim2.new(0, 5, 0, 25),
