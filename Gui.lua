...
local Themes = {
    Cyberpunk = {
        ...
        Element = Color3.fromRGB(30, 25, 45),
        Accent = Color3.fromRGB(0, 200, 255),
        Text = Color3.fromRGB(200, 200, 220),
        Toggle = Color3.fromRGB(40, 35, 55),
        TabInactive = Color3.fromRGB(25, 20, 40),
        DropdownOption = Color3.fromRGB(35, 30, 50)
    },
    Green = {
        Background = Color3.fromRGB(20, 20, 20),
        Element = Color3.fromRGB(30, 30, 30),
        Accent = Color3.fromRGB(50, 120, 80),
...
function Linux.Create(config)
    ...
    Linux.Theme = Themes[config.Theme] or Themes.Cyberpunk
    ...
    local MinimizeIcon = Linux.Instance("ImageLabel", {
        ...
        ImageColor3 = Linux.Theme.Accent, -- Ícone verde no tema Green
        ZIndex = 3
    })
    ...
    function LinuxLib.Tab(config)
        ...
        if config.Icon and config.Icon.Enabled then
            TabIcon = Linux.Instance("ImageLabel", {
                ...
                ImageColor3 = Color3.fromRGB(130, 130, 150),
                ZIndex = 2
            })
        end
        ...
        TabBtn.MouseButton1Click:Connect(function()
            for _, tab in pairs(Tabs) do
                ...
                tab.Text.TextColor3 = Color3.fromRGB(130, 130, 150)
                if tab.Icon then
                    tab.Icon.ImageColor3 = Color3.fromRGB(130, 130, 150)
                end
            end
            TabContent.Visible = true
            TabText.TextColor3 = Linux.Theme.Accent -- Texto da aba selecionada fica verde
            if TabIcon then
                TabIcon.ImageColor3 = Linux.Theme.Accent -- Ícone da aba selecionada fica verde
            end
            CurrentTab = tabIndex
        end)
        ...
        function TabElements.Button(config)
            ...
            local Btn = Linux.Instance("TextButton", {
                ...
                Font = Enum.Font.SourceSans,
                Text = config.Name,
                TextColor3 = Linux.Theme.Text, -- Texto mais branco
                TextSize = 14,
                TextXAlignment = Enum.TextXAlignment.Left,
                ZIndex = 1,
                AutoButtonColor = false
            ...
            local BtnIcon = Linux.Instance("ImageLabel", {
                ...
                ImageColor3 = Linux.Theme.Accent, -- Ícone verde
                ZIndex = 1
            })
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(Knob, tween, {Position = UDim2.new(1, -18, 0, 2), BackgroundColor3 = Linux.Theme.Text}):Play()
                else
                    TweenService:Create(ToggleFill, tween, {BackgroundColor3 = Linux.Theme.Toggle, Size = UDim2.new(0, 0, 1, 0)}):Play()
                    TweenService:Create(Knob, tween, {Position = UDim2.new(0, 2, 0, 2), BackgroundColor3 = Color3.fromRGB(130, 130, 150)}):Play()
                end
            end
        ...
        function TabElements.Dropdown(config)
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.SourceSans,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and Linux.Theme.Accent or Linux.Theme.Text, -- Opção selecionada fica verde
                            TextSize = 14,
                            TextXAlignment = Enum.TextXAlignment.Left,
                            ZIndex = 3,
                            AutoButtonColor = false
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            ...
                            for _, btn in pairs(DropFrame:GetChildren()) do
                                if btn:IsA("TextButton") then
                                    btn.TextColor3 = btn.Text == tostring(opt) and Linux.Theme.Accent or Linux.Theme.Text -- Opção selecionada fica verde
                                end
                            end
            ...
            local function SetValue(value)
                if table.find(Options, value) then
                    ...
                    for _, btn in pairs(DropFrame:GetChildren()) do
                        if btn:IsA("TextButton") then
                            btn.TextColor3 = btn.Text == tostring(value) and Linux.Theme.Accent or Linux.Theme.Text -- Opção selecionada fica verde
                        end
                    end
        ...
        function TabElements.Slider(config)
            ...
            local FillBar = Linux.Instance("Frame", {
                Parent = SliderBar,
                BackgroundColor3 = Linux.Theme.Accent, -- Preenchimento verde
                Size = UDim2.new(0, 0, 1, 0),
                Position = UDim2.new(0, 0, 0, 0),
                ZIndex = 1
            })
