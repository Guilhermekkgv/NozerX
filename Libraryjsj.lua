...
function Linux.Create(config)
    ...
    function LinuxLib.UpdateTheme()
        for _, v in pairs(LinuxUI:GetDescendants()) do
            if v:IsA("Frame") then
                if v.BackgroundColor3 == Linux.Theme.Background then
                    v.BackgroundColor3 = Linux.Theme.Background
                elseif v.BackgroundColor3 == Linux.Theme.Element then
                    v.BackgroundColor3 = Linux.Theme.Element
                elseif v.BackgroundColor3 == Linux.Theme.Accent then
                    v.BackgroundColor3 = Linux.Theme.Accent
                elseif v.BackgroundColor3 == Linux.Theme.Toggle then
                    v.BackgroundColor3 = Linux.Theme.Toggle
                elseif v.BackgroundColor3 == Linux.Theme.TabInactive then
                    v.BackgroundColor3 = Linux.Theme.TabInactive
                elseif v.BackgroundColor3 == Linux.Theme.DropdownOption then
                    v.BackgroundColor3 = Linux.Theme.DropdownOption
                end
            elseif v:IsA("TextLabel") or v:IsA("TextButton") or v:IsA("TextBox") then
                if v.TextColor3 == Linux.Theme.Text then
                    v.TextColor3 = Linux.Theme.Text
                end
            elseif v:IsA("ImageLabel") then
                if v.ImageColor3 == Linux.Theme.Text then
                    v.ImageColor3 = Linux.Theme.Text
                end
            end
        end
    end
    ...
    local settingsTabEnabled = config.SettingsTabEnabled == nil and true or config.SettingsTabEnabled

    if settingsTabEnabled then
        local SettingsTab = LinuxLib.Tab({
            Name = "Settings",
            Icon = {
                Enabled = true,
                Image = "rbxassetid://10734949875"
            }
        })
        ...
        SettingsTab.ColorPicker({
            ...
            Callback = function(color)
                Linux.Theme.Background = color
                LinuxLib.UpdateTheme()
            end
        })
        ...
        SettingsTab.ColorPicker({
            Name = "Toggle Color",
            Callback = function(color)
                Linux.Theme.Toggle = color
                LinuxLib.UpdateTheme()
            end
        })

        SettingsTab.ColorPicker({
            Name = "Tab Inactive Color",
            Callback = function(color)
                Linux.Theme.TabInactive = color
                LinuxLib.UpdateTheme()
            end
        })
        ...
        SettingsTab.ColorPicker({
            ...
            Callback = function(color)
                Linux.Theme.DropdownOption = color
                LinuxLib.UpdateTheme()
            end
        })
        ...
        SettingsTab.Button({
            ...
            Callback = function()
                Linux:Notify({
                    ...
                    Content = "Your theme settings have been saved!",
                    Duration = 3
                })
            end
        })
