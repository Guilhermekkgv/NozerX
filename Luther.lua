...
function Linux.Create(config)
    ...
    local useTransparency = config.Transparency == true
    ...
    local Main = Linux.Instance("Frame", {
        ...
        BackgroundTransparency = useTransparency and 0.1 or 0,
        Size = uiSize,
    ...
    function LinuxLib.Tab(config)
        ...
        local TabBtn = Linux.Instance("TextButton", {
            ...
            BackgroundTransparency = useTransparency and 0.3 or 0,
        ...
        function TabElements.Button(config)
            ...
            local showDesc = config.ShowDescription == nil and true or config.ShowDescription
            local BtnFrame = Linux.Instance("Frame", {
                Parent = ElementContainer,
                BackgroundColor3 = Linux.Theme.Element,
                BackgroundTransparency = useTransparency and 0.3 or 0,
                Size = UDim2.new(1, -5, 0, 30),
                AutomaticSize = showDesc and Enum.AutomaticSize.Y or Enum.AutomaticSize.None,
                ZIndex = 1,
            ...
            local Description
            if showDesc and config.Description then
                Description = Linux.Instance("TextLabel", {
                    Parent = BtnFrame,
                    BackgroundTransparency = 1,
        ...
        function TabElements.Toggle(config)
            ...
            local TogglePadding = Linux.Instance("UIPadding", {
                Parent = Toggle,
                PaddingBottom = UDim.new(0, 5)
            })
        ...
        function TabElements.Slider(config)
            ...
            local SliderPadding = Linux.Instance("UIPadding", {
                Parent = Slider,
                PaddingBottom = UDim.new(0, 5)
            })
            ...
            local function ExecuteCallback(state)
                ...
                elseif Mode == "Toggle" then
                    if state then
                        ...
                        spawn(function() config.Callback(ToggleState) end)
                    end
                elseif Mode == "Always" then
                    if ToggleState then
                        spawn(function() config.Callback(true) end)
                    end
                end
            end
        ...
        function TabElements.ColorPicker(config)
            ...
            local function UpdateColor()
                ...
                spawn(function() config.Callback(color) end)
            end
        ...
        function TabElements.Paragraph(config)
            ...
            local ParagraphFrame = Linux.Instance("Frame", {
                ...
                BackgroundColor3 = Linux.Theme.Element,
                BackgroundTransparency = useTransparency and 0.3 or 0,
                Size = UDim2.new(1, -5, 0, showDesc and 0 or 20),
                AutomaticSize = showDesc and Enum.AutomaticSize.Y or Enum.AutomaticSize.None,
                ZIndex = 1,
                LayoutOrder = elementOrder
            })
            ...
            local ParagraphText
            if showDesc and config.Description then
                ParagraphText = Linux.Instance("TextLabel", {
                    Parent = ParagraphFrame,
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, -10, 0, 0),
                    Position = UDim2.new(0, 5, 0, 25),
            ...
            local function SetText(newText)
                if showDesc then
                    ParagraphText.Text = tostring(newText)
                end
            end
            ...
            local function GetText()
                return showDesc and ParagraphText and ParagraphText.Text or ""
            end
