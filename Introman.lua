...
function Linux.Create(config)
    ...
    local ProgressBarFrame = Linux.Instance("Frame", {
        Parent = IntroFrame,
    ...
    local ProgressBarFill = Linux.Instance("Frame", {
        Parent = ProgressBarFrame,
    ...
    spawn(function()
        ...
        local progressInfo = TweenInfo.new(totalLoadTime, Enum.EasingStyle.Linear)
        local progressTween = TweenService:Create(ProgressBarFill, progressInfo, {Size = UDim2.new(1, 0, 1, 0)})
        progressTween:Play()
        ...
        TweenService:Create(ProgressBarFrame, fadeOut, {BackgroundTransparency = 1}):Play()
